$(document).ready(function () {
    ...
    var buttons = ["Fail", "Office monkey", "Steal Yo Girl", "Feels", "Trending Memes", "Viral Moments"];

    function displayGif() {

        var meme = $(this).attr("data-name");
        var queryURL = `https://api.giphy.com/v1/gifs/search?api_key=fMbsbXx9KqrIAiyiMzxd4syYUsMc929S&limit=10&q=${meme}`;
